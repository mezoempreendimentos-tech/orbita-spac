...
const styles = StyleSheet.create({
  page: { paddingTop: 42, paddingBottom: 48, paddingHorizontal: 42, fontSize: 9, color: "#102544", fontFamily: "Helvetica" },
  header: { backgroundColor: "#071a38", padding: 18, borderRadius: 8, marginBottom: 18 },
  eyebrow: { color: "#68d7ef", fontSize: 8, fontFamily: "Helvetica-Bold", letterSpacing: 1.2 },
  title: { color: "#ffffff", fontSize: 18, fontFamily: "Helvetica-Bold", marginTop: 7 },
  meta: { color: "#c9e0ee", fontSize: 9, marginTop: 5 },
  section: { border: "1 solid #d7e2ec", borderRadius: 7, padding: 12, marginBottom: 11 },
  sectionTitle: { color: "#0b6080", fontFamily: "Helvetica-Bold", fontSize: 10, marginBottom: 8, textTransform: "uppercase" },
  grid: { display: "flex", flexDirection: "row", flexWrap: "wrap", gap: 8 },
  field: { width: "48%", marginBottom: 7 },
  fieldFull: { width: "100%", marginBottom: 7 },
  label: { color: "#60738c", fontFamily: "Helvetica-Bold", fontSize: 7, textTransform: "uppercase", marginBottom: 2 },
  value: { lineHeight: 1.35 },
  item: { padding: 10, backgroundColor: "#f4f8fb", borderRadius: 6, marginTop: 8 },
  itemTitle: { color: "#071a38", fontFamily: "Helvetica-Bold", fontSize: 10, marginBottom: 5 },
  certification: { marginTop: 9, padding: 10, borderRadius: 6, backgroundColor: "#e7f6ef", color: "#176146", lineHeight: 1.4 },
  signature: { marginTop: 8, paddingTop: 10, borderTop: "1 solid #bdcadd" },
  ...
  code: { fontFamily: "Courier", fontSize: 7, color: "#0b6080", marginTop: 4 },
  footer: { position: "absolute", bottom: 22, left: 42, right: 42, color: "#62748b", fontSize: 7, display: "flex", flexDirection: "row", justifyContent: "space-between" },
});
